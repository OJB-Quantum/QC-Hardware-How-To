...
Example of Cascaded Mach-Zehnder Interferometers (MZIs) on a Cryogenically Compatible Quantum Photonics Chip. The Piezo-Optomechanical Components are Designed to Impart Strain on the Optical Waveguides for Chip Control.
(Dong et al., Nat. Photon., 2021).
