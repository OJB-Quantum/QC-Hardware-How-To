...
| **Trapped Ions**                       | **Fluorescence Detection** <br> (e.g., electron shelving technique) | - Presence or absence of emitted photons (fluorescence) | - A laser tuned to an electronic transition lights up one qubit state (“bright”) while another remains dark. <br> - Counting photons above a threshold indicates $|1\rangle$ (or $|0\rangle$), collapsing the ion’s internal state. <br> - Non-resonant states do not fluoresce, providing a clear binary readout. | 
