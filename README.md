...
| Quantum-Dot PA/ QDPA | ≈0.6 MHz at 15 dB in the modeled optimized 2022 design; the 2022 prototype demonstrated −3 to +3 dB. A 2026 DQD SAPA reached 11.28 dB, with explicit 3-dB BW unreported | −70 to −47 dBm in the 2022 experiment; −68.3 dBm at the room-temperature source in the 2026 DQD SAPA | 2022 gate-pumped device: f<sub>p</sub> ≈ 2f<sub>s</sub>, with 3.627 GHz pump for f<sub>s</sub> = 1.8135 GHz. 2026 DQD SAPA: near-degenerate 4WM with f<sub>p</sub> − f<sub>s</sub> ≈ 5 kHz near 5.194 GHz |
